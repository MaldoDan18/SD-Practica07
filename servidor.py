    ...
    def reset_sale(self):
        ...
        try:
            with self.meta_lock:
                ...
                for buyer_type in self.registered_buyers_by_type:
                    self.registered_buyers_by_type[buyer_type] = 0
                for buyer_type in self.purchased_by_type:
                    self.purchased_by_type[buyer_type] = 0
                self.sold_count = 0
                ...
                self.close_reason = None
                self.recent_events = []
                self.sale_id = f"sale-{uuid.uuid4().hex[:8]}"
